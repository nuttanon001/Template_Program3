...
namespace Template_Program.Migrations
{
    ...
    [Migration("20181123062906_ModifiedDataBase")]
            ...
            modelBuilder.Entity("Template_Program.Models.Breed", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            BreedId = 1,
                            CreateDate = new DateTime(2018, 11, 23, 13, 29, 5, 708, DateTimeKind.Local).AddTicks(4042),
                            Description = "สุนัข",
                            Name = "สุนัข"
                        },
                        new
                        {
                            BreedId = 2,
                            CreateDate = new DateTime(2018, 11, 23, 13, 29, 5, 724, DateTimeKind.Local).AddTicks(5757),
                            Description = "แมว",
                            Name = "แมว"
                        },
                        new
                        {
                            BreedId = 3,
                            CreateDate = new DateTime(2018, 11, 23, 13, 29, 5, 724, DateTimeKind.Local).AddTicks(5769),
                            Description = "เต่า",
                            Name = "เต่า"
                        },
                        new
                        {
                            BreedId = 4,
                            CreateDate = new DateTime(2018, 11, 23, 13, 29, 5, 724, DateTimeKind.Local).AddTicks(5773),
                            Description = "กระรอก",
                            Name = "กระรอก"
                        },
                        new
