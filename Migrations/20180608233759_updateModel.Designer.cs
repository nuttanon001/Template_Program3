...
namespace Template_Program.Migrations
{
    ...
    [Migration("20180608233759_updateModel")]
            ...
            modelBuilder.Entity("Template_Program.Models.Breed", b =>
                {
                    ...
                    b.HasData(
                        new { BreedId = 1, CreateDate = new DateTime(2018, 6, 9, 6, 37, 58, 359, DateTimeKind.Local), Description = "สุนัข", Name = "สุนัข" },
                        new { BreedId = 2, CreateDate = new DateTime(2018, 6, 9, 6, 37, 58, 360, DateTimeKind.Local), Description = "แมว", Name = "แมว" },
                        new { BreedId = 3, CreateDate = new DateTime(2018, 6, 9, 6, 37, 58, 360, DateTimeKind.Local), Description = "เต่า", Name = "เต่า" },
                        new { BreedId = 4, CreateDate = new DateTime(2018, 6, 9, 6, 37, 58, 360, DateTimeKind.Local), Description = "กระรอก", Name = "กระรอก" },
                        new { BreedId = 5, CreateDate = new DateTime(2018, 6, 9, 6, 37, 58, 360, DateTimeKind.Local), Description = "กระต่าย", Name = "กระต่าย" }
                    );
                });
