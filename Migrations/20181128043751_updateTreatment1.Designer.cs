...
namespace Template_Program.Migrations
{
    ...
    [Migration("20181128043751_updateTreatment1")]
    partial class updateTreatment1
    {
            ...
            modelBuilder.Entity("Template_Program.Models.Breed", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            BreedId = 1,
                            CreateDate = new DateTime(2018, 11, 28, 11, 37, 51, 335, DateTimeKind.Local).AddTicks(9843),
                            Description = "สุนัข",
                            Name = "สุนัข"
                        },
                        new
                        {
                            BreedId = 2,
                            CreateDate = new DateTime(2018, 11, 28, 11, 37, 51, 336, DateTimeKind.Local).AddTicks(4687),
                            Description = "แมว",
                            Name = "แมว"
                        },
                        new
                        {
                            BreedId = 3,
                            CreateDate = new DateTime(2018, 11, 28, 11, 37, 51, 336, DateTimeKind.Local).AddTicks(4700),
                            Description = "เต่า",
                            Name = "เต่า"
                        },
                        new
                        ...
                        {
                            BreedId = 5,
                            CreateDate = new DateTime(2018, 11, 28, 11, 37, 51, 336, DateTimeKind.Local).AddTicks(4704),
                            Description = "กระต่าย",
                            Name = "กระต่าย"
                        });
                });
