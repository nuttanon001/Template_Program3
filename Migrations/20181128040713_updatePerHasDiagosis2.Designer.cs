...
namespace Template_Program.Migrations
{
    ...
    [Migration("20181128040713_updatePerHasDiagosis2")]
    partial class updatePerHasDiagosis2
    {
            ...
            modelBuilder.Entity("Template_Program.Models.Breed", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            BreedId = 1,
                            CreateDate = new DateTime(2018, 11, 28, 11, 7, 13, 735, DateTimeKind.Local).AddTicks(3425),
                            Description = "สุนัข",
                            Name = "สุนัข"
                        },
                        new
                        {
                            BreedId = 2,
                            CreateDate = new DateTime(2018, 11, 28, 11, 7, 13, 735, DateTimeKind.Local).AddTicks(7768),
                            Description = "แมว",
                            Name = "แมว"
                        },
                        new
                        {
                            BreedId = 3,
                            CreateDate = new DateTime(2018, 11, 28, 11, 7, 13, 735, DateTimeKind.Local).AddTicks(7780),
                            Description = "เต่า",
                            Name = "เต่า"
                        },
                        new
                        {
                            BreedId = 4,
                            CreateDate = new DateTime(2018, 11, 28, 11, 7, 13, 735, DateTimeKind.Local).AddTicks(7785),
                            Description = "กระรอก",
                            Name = "กระรอก"
                        },
                        new
