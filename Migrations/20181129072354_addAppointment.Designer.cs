...
namespace Template_Program.Migrations
{
    ...
    [Migration("20181129072354_addAppointment")]
            ...
            modelBuilder.Entity("Template_Program.Models.Breed", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            BreedId = 1,
                            CreateDate = new DateTime(2018, 11, 29, 14, 23, 53, 790, DateTimeKind.Local).AddTicks(7985),
                            Description = "สุนัข",
                            Name = "สุนัข"
                        },
                        new
                        {
                            BreedId = 2,
                            CreateDate = new DateTime(2018, 11, 29, 14, 23, 53, 791, DateTimeKind.Local).AddTicks(2767),
                            Description = "แมว",
                            Name = "แมว"
                        },
                        new
                        {
                            BreedId = 3,
                            CreateDate = new DateTime(2018, 11, 29, 14, 23, 53, 791, DateTimeKind.Local).AddTicks(2779),
                            Description = "เต่า",
                            Name = "เต่า"
                        },
                        new
                        {
                            BreedId = 4,
                            CreateDate = new DateTime(2018, 11, 29, 14, 23, 53, 791, DateTimeKind.Local).AddTicks(2783),
                            Description = "กระรอก",
                            Name = "กระรอก"
                        },
                        new
